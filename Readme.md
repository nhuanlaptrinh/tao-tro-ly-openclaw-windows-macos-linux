...
- Password VPS con: <PASSWORD_VPS_CON>
- Tên trợ lý: Trợ Lý TrolyfanpageCSKH
- Cách xưng hô: anh và em
- Telegram Chat ID quản trị: <TELEGRAM_CHAT_ID_ADMIN>
- Telegram Group ID: <TELEGRAM_GROUP_ID>
- Không cần mention trong nhóm
- Token Codex API Key: <TOKEN_CODEX_API_KEY>
